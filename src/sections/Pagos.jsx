...
const Pagos = () => {
    return (
        <div className='gradiente container mx-auto p-1'>
            <div className='mx-auto p-4 backdrop-filter backdrop-blur-xl bg-white dark:bg-darkTheme-background dark:bg-opacity-30 bg-opacity-30 h-3/4'>
                <div className="flex flex-col md:flex-row p-4">
                    ...
                    <div className="md:w-1/2 p-4 flex flex-col justify-center">
                        <h2 className="text-3xl sm:text-4xl md:text-6xl font-bold mb-4 text-lightTheme-primary dark:text-white">Realiza tus pagos de forma rápida y sencilla</h2>
                        <p className="text-gray-700 dark:text-gray-300 mb-2">Paga tus facturas de:</p>
                        ...
                        <p className="text-gray-700 dark:text-gray-300 mt-4">Todo en un solo lugar, de manera segura y confiable.</p>
                    </div>
                </div>
            </div>
        </div>
